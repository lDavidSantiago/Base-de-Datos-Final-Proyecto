...
class Clientes(customtkinter.CTk):
    def __init__(self):
        super().__init__()
        ...
        def crear_ventana_entrada():
            ...
            tk.Label(ventana_entrada, text="ID").grid(row=0)
            ...
            tk.Label(ventana_entrada, text="Apellido").grid(row=2)
            ...
            boton_anadir = tk.Button(ventana_entrada, text="Añadir", command=lambda: insertcliente(id_entry.get(), nombre_entry.get(), apellido_entry.get(), telefono_entry.get()))            
        ...
        def crear_ventana_borrar():
            ...
            boton_borrar = tk.Button(ventana_borrar, text="Borrar", command=lambda: deletecliente(id_entry.get()))            
        ...
        def crear_ventana_update():
            ...
            label4 = tk.Label(new_window, text="Apellido")
            ...
            update_button = tk.Button(new_window, text="Actualizar", command=lambda: updateclient(entry1.get(), entry2.get(), entry3.get(), entry4.get(), entry5.get()))
            update_button.grid(row=5, column=1)  # Colocar el botón debajo de las entradas

            new_window.mainloop()
        self.sidebar_button_3 = customtkinter.CTkButton(self.sidebar_frame, command=crear_ventana_entrada, text="Insertar Cliente")
        self.sidebar_button_3.grid(row=3, column=0, padx=20, pady=10)
        self.sidebar_button_4 = customtkinter.CTkButton(self.sidebar_frame, command=crear_ventana_borrar, text="Borrar Cliente")
        self.sidebar_button_4.grid(row=4, column=0, padx=20, pady=10)
        self.sidebar_button_5 = customtkinter.CTkButton(self.sidebar_frame, command=crear_ventana_update, text="Actualizar Cliente")
        ...
        self.main_button_1 = customtkinter.CTkButton(text="Consultar",master=self, fg_color="transparent", border_width=2, text_color=("gray10", "#DCE4EE"), command=lambda: self.mostrar_tabla_event("Cliente"))
