...
from ProductosMateria import ProductosMateria
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.sidebar_button_5 = customtkinter.CTkButton(self.sidebar_frame, command=self.callSchool,text="Colegio")
        ...
        self.sidebar_button_7 = customtkinter.CTkButton(self.sidebar_frame, command=self.callprov,text="Proveedores")
        self.sidebar_button_7.grid(row=7, column=0, padx=20, pady=10)
        self.sidebar_button_7 = customtkinter.CTkButton(self.sidebar_frame, command=self.callUniforms,text="Uniformes")
        self.sidebar_button_7.grid(row=8, column=0, padx=20, pady=10)
        self.sidebar_button_7 = customtkinter.CTkButton(self.sidebar_frame, command=self.callmateria,text="Materias Primas")
        self.sidebar_button_7.grid(row=9, column=0, padx=20, pady=10)
        self.sidebar_button_8 = customtkinter.CTkButton(self.sidebar_frame, command=self.callprodmat,text="Gestion Productos con Materias P")
        self.sidebar_button_8.grid(row=10, column=0, padx=20, pady=10)
        self.sidebar_button_9 = customtkinter.CTkButton(self.sidebar_frame, command=self.informes,text="Informes")
        self.sidebar_button_9.grid(row=11, column=0, padx=20, pady=10)
...
""")
    ...
    def callmateria(self):
        ...
        self.iconify()
        materia.mainloop()
    def callprodmat(self):
        prodmat = ProductosMateria()
        self.iconify()
        prodmat.mainloop()
    def informes(self):
        informes = Informes()
